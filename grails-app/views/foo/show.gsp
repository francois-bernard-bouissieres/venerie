...
<html>
	...
	<body>
		...
		<div id="show-foo" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:fooInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${fooInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
